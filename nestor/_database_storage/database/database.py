...
class DatabaseNeo4J(object):
    ...
    it is instantiate using:
        ...
        - schema : a dictionary the desrcibe the schame of the database (node label, edges label, properies name) -see the YAML file _database_storage/database/DatabaseSchema.yaml-
