...
class Ui_KPIWindow(object):
    def setupUi(self, KPIWindow):
        ...
        self.Left_gridLayout_Plot = QtWidgets.QGridLayout()
        self.Left_gridLayout_Plot.setObjectName("Left_gridLayout_Plot")
        self.Right_graphicsView_Plot = QtWidgets.QGraphicsView(self.horizontalLayoutWidget)
        self.Right_graphicsView_Plot.setObjectName("Right_graphicsView_Plot")
        self.Left_gridLayout_Plot.addWidget(self.Right_graphicsView_Plot, 0, 0, 1, 1)
        self.hLayoutGeneral.addLayout(self.Left_gridLayout_Plot)
