...
class Ui_MainWindow_openFiles(object):
    def setupUi(self, MainWindow_openFiles):
        ...
        self.gridLayout_openFiles_configValues.addWidget(self.label_openFiles_numberTokenShow, 0, 3, 1, 1, QtCore.Qt.AlignHCenter)
        spacerItem1 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_openFiles_configValues.addItem(spacerItem1, 0, 2, 1, 1)
        ...
        self.gridLayout_openFiles_configValues.addWidget(self.lineEdit_openFiles_numberTokenShow, 1, 3, 1, 1)
