...
|---|---|---|---|
| transformer | object TokenExtractor | the (TRAINED) token extractor used to generate the ranked list of vocab. | None |
| filename | str | the file location to read/write a csv containing a formatted vocabulary list | None |
| init | str or pd.Dataframe | file location of csv or dataframe of existing vocab list to read and update
token classification values from | None |
...
| Name | Type | Description | Default |
|---|---|---|---|
| tag_df | pd.DataFrame | heirarchical-column df containing | None |
...
| Name | Type | Description | Default |
|---|---|---|---|
| transformer | object KeywordExtractor | instantiated, can be pre-trained | None |
| raw_text | pd.Series | contains jargon/slang-filled raw text to be tagged | None |
| vocab_df | pd.DataFrame | An existing vocabulary dataframe or .csv filename, expected in the format of
kex.generate_vocabulary_df(). | None |
| readable | bool, default False | whether to return readable, categorized, comma-sep str format (takes longer) | None |

**Returns:**

| Type | Description |
|---|---|
| pd.DataFrame, extracted tags for each document, whether binary indicator (default) | None |
...
| Name | Type | Description | Default |
|---|---|---|---|
| raw_text | pd.Series | contains text with known jargon, slang, etc | None |
| vocab | pd.DataFrame | contains alias' keyed on known slang, jargon, etc. | None |
...
| Name | Type | Description | Default |
|---|---|---|---|
| X | {array-like, sparse matrix, dataframe} of shape                 (n_samples, n_features) | None | None |
| y | ndarray of shape (n_samples,), default=None | Target values. | None |
