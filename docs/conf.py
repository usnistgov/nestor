...
exclude_patterns = ["_build", "Thumbs.db", ".DS_Store", "**.ipynb_checkpoints", "_pdf"]
...
latex_documents = [
    (master_doc, "nestor.tex", "Nestor Documentation", author, "manual"),
]
...
man_pages = [(master_doc, "nestor", "nestor Documentation", [author], 1)]
